...
public class CipherStorageKeystoreAESCBC implements CipherStorage {
    ...
    @TargetApi(Build.VERSION_CODES.M)
    @Override
    public EncryptionResult encrypt(@NonNull String service, @NonNull String itemKey, @NonNull String value, SecurityLevel level) throws CryptoFailedException {
        ...
        try {
            ...
            try {
                ...
                if (retry) {
                    ...
                    return encrypt(service, itemKey, value, level);
                } else {
                    throw ex;
                }
            }
    ...
    @Override
    public DecryptionResult decrypt(@NonNull String service, @NonNull String itemKey, @NonNull byte[] value) throws CryptoFailedException {
        service = getDefaultServiceIfEmpty(service);
        ...
        try {
            ...
            String decryptedValue = decryptBytes(key, value);

            return new DecryptionResult(itemKey, decryptedValue, getSecurityLevel((SecretKey) key));
