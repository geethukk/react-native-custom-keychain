...
public class KeychainModule extends ReactContextBaseJavaModule {
  ...
  private final Map<String, CipherStorage> cipherStorageMap = new HashMap<>();
    ...
    @ReactMethod
    public void setItem(String service, String key, String value, String minimumSecurityLevel, Promise promise) {
        try {
            ...
            EncryptionResult result = currentCipherStorage.encrypt(service, key, value, level);
    ...
    public void getItem(String key,String service, Promise promise) {
        try {
            ...
            final DecryptionResult decryptionResult = decryptCredentials(key,service, currentCipherStorage, resultSet);

            WritableMap credentials = Arguments.createMap();

            credentials.putString("service", service);
            credentials.putString("key", decryptionResult.key);
            credentials.putString("value", decryptionResult.value);
    ...
    private DecryptionResult decryptCredentials(String key,String service, CipherStorage currentCipherStorage, ResultSet resultSet) throws CryptoFailedException, KeyStoreAccessException {
        if (resultSet.cipherStorageName.equals(currentCipherStorage.getCipherStorageName())) {
            ...
            return currentCipherStorage.decrypt(service, key, resultSet.valueBytes);
        }
        ...
        DecryptionResult decryptionResult = oldCipherStorage.decrypt(service, key,resultSet.valueBytes);
    ...
    private void migrateCipherStorage(String service, CipherStorage newCipherStorage, CipherStorage oldCipherStorage, DecryptionResult decryptionResult) throws KeyStoreAccessException, CryptoFailedException {
        ...
        EncryptionResult encryptionResult = newCipherStorage.encrypt(service, decryptionResult.key, decryptionResult.value, decryptionResult.getSecurityLevel());
